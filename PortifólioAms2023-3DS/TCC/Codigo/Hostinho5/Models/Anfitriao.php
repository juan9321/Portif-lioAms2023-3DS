...
class Anfitriao extends Conexao {
    ...
    {
        try {
            $stmt = $this->mysqli->prepare("INSERT INTO anfitriao (`nome`, `telefone`, `endereco`, `cidade`, `bairro`, `num_casa`, `complemento`, `cep`, `cpf`, `genero`, `dt_nasc`, `email`, `senha`,  `valor_hora`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->bind_param("ssssssssssssss", $anfitriao->nome, $anfitriao->telefone, $anfitriao->endereco, $anfitriao->cidade, $anfitriao->bairro, $anfitriao->num_casa, $anfitriao->complemento, $anfitriao->cep, $anfitriao->cpf, $anfitriao->genero, $anfitriao->dt_nasc, $anfitriao->email, $anfitriao->senha,  $anfitriao->valor_hora);
	...
	public function update($id){
		try {
			$stmt = $this->mysqli->prepare("UPDATE anfitriao SET nome=?, telefone=?, endereco=?, cidade=?, bairro=?, num_casa=?, complemento=?, cep=?, cpf=?, genero=?, dt_nasc=?, email=?, senha=?, valor_hora=? WHERE cod=?");
			$stmt->bind_param("ssssssssssssssi", $this->nome, $this->telefone, $this->endereco, $this->cidade, $this->bairro, $this->num_casa, $this->complemento, $this->cep, $this->cpf, $this->genero, $this->dt_nasc, $this->email, $this->senha, $this->valor_hora, $id);
