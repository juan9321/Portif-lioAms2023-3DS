...
$listars = $anfitriaoController->listarDadosAnfitriaoLogado($anfitriaoCod);

if (!empty($listars)) {
    foreach ($listars as $listar) {
        echo "<tr>";
        echo "<td>" . $listar['nome'] . "</td>";
        echo "<td><br>" . $listar['telefone'] . "</td>";
        echo "<td><br>" . $listar['endereco'] . "</td>";
        echo "</tr>";
    }
} else {
...
?>
      ...
      <div class="container">
        ...
        <button class="comic-button">Editar Dados Pessoais</button>
        <br>
