...
<body>
    ...
    <!-- fim do navbar-->
        ...
        <?php
            ...
            // Verifique se a variável de sessão "logado" está definida e é igual a true
            if (!isset($_SESSION['logado']) || $_SESSION['logado'] !== true) {
                ...
                header("refresh:10;url=login-cadastro.php"); // Redirecione para a página de login após 3 segundos
                exit();
            }
